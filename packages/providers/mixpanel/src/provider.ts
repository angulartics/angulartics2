...
@Injectable()
export class AngularticsMixpanel {
  ...
  constructor(
    ...
    this.angulartics.setUserPropertiesOnce.subscribe((x: any) => this.setUserPropertiesOnce(x));

    this.angulartics.setSuperProperties.subscribe((x: any) => this.setSuperProperties(x));

    this.angulartics.setSuperPropertiesOnce.subscribe((x: any) => this.setSuperPropertiesOnce(x));
