...
@Injectable()
export class AngularticsAppInsights {
    ...
    constructor(private angulartics: Angulartics,
        ...
        this.angulartics.settings.appInsights = {
            userId: null
        };
    ...
    setUsername(userId: string) {
        this.angulartics.settings.appInsights.userId = userId;
        appInsights.setAuthenticatedUserContext(userId);
    }

    setUserProperties(properties: any) {
        if (properties.userId) {
            this.angulartics.settings.appInsights.userId = properties.userId;
        }

        if (properties.accountId) {
            appInsights.setAuthenticatedUserContext(
                this.angulartics.settings.appInsights.userId,
