...
describe('Angulartics2IBMDigitalAnalytics', () => {
    ...
    describe('on init', () => {
        ...
        it('should complain if global IBM Digital Analytics functions were not loaded',
    ...
    describe('while active', () => {
        ...
        it('should track cmCreateProductviewTag event',
            fakeAsync(inject([Angulartics2, Angulartics2IBMDigitalAnalytics],
                (angulartics2: Angulartics2, angulartics2IBMDigitalAnalytics: Angulartics2IBMDigitalAnalytics) => {
                    ...
                    advance(fixture);
                    expect(window.cmCreateProductviewTag).toHaveBeenCalledWith('123', 'Apples', 'Fruits', 'attributes', 'virtual category');
                }),
            ),
        );


        it('should track cmCreateShopAction5Tag event',
            fakeAsync(inject([Angulartics2, Angulartics2IBMDigitalAnalytics],
                (angulartics2: Angulartics2, angulartics2IBMDigitalAnalytics: Angulartics2IBMDigitalAnalytics) => {
                    fixture = createRoot(RootCmp);
                    angulartics2.eventTrack.next({
        ...
        it('should track cmCreateShopAction9Tag event',
            fakeAsync(inject([Angulartics2, Angulartics2IBMDigitalAnalytics],
                (angulartics2: Angulartics2, angulartics2IBMDigitalAnalytics: Angulartics2IBMDigitalAnalytics) => {
                    fixture = createRoot(RootCmp);
                    angulartics2.eventTrack.next({
        ...
        it('should track cmCreateOrderTag event',
            fakeAsync(inject([Angulartics2, Angulartics2IBMDigitalAnalytics],
                (angulartics2: Angulartics2, angulartics2IBMDigitalAnalytics: Angulartics2IBMDigitalAnalytics) => {
                    fixture = createRoot(RootCmp);
                    angulartics2.eventTrack.next({
        ...
        it('should track cmCreateRegistrationTag event',
            fakeAsync(inject([Angulartics2, Angulartics2IBMDigitalAnalytics],
                (angulartics2: Angulartics2, angulartics2IBMDigitalAnalytics: Angulartics2IBMDigitalAnalytics) => {
                    fixture = createRoot(RootCmp);
                    angulartics2.eventTrack.next({
        ...
        it('should track cmCreateElementTag event',
            fakeAsync(inject([Angulartics2, Angulartics2IBMDigitalAnalytics],
                (angulartics2: Angulartics2, angulartics2IBMDigitalAnalytics: Angulartics2IBMDigitalAnalytics) => {
                    fixture = createRoot(RootCmp);
                    angulartics2.eventTrack.next({
        ...
        it('should track cmCreateConversionEventTag event',
            fakeAsync(inject([Angulartics2, Angulartics2IBMDigitalAnalytics],
                (angulartics2: Angulartics2, angulartics2IBMDigitalAnalytics: Angulartics2IBMDigitalAnalytics) => {
                    fixture = createRoot(RootCmp);
                    angulartics2.eventTrack.next({
        ...
        it('should complain for unsupported event type',
            fakeAsync(inject([Angulartics2, Angulartics2IBMDigitalAnalytics],
                (angulartics2: Angulartics2, angulartics2IBMDigitalAnalytics: Angulartics2IBMDigitalAnalytics) => {
                    fixture = createRoot(RootCmp);
                    angulartics2.eventTrack.next({
