...
describe('Angulartics2Intercom', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [TestModule],
      providers: [Angulartics2Intercom],
    });
  ...
  it('should track pages', fakeAsync(
    inject(
      [Angulartics2, Angulartics2Intercom],
  ...
  it('should set user properties if no userId present', fakeAsync(
    inject(
      [Angulartics2, Angulartics2Intercom],
      (angulartics2: Angulartics2, angulartics2Intercom: Angulartics2Intercom) => {
        fixture = createRoot(RootCmp);
  ...
  it('should set user properties once if no userId present', fakeAsync(
    inject(
      [Angulartics2, Angulartics2Intercom],
      (angulartics2: Angulartics2, angulartics2Intercom: Angulartics2Intercom) => {
        fixture = createRoot(RootCmp);
